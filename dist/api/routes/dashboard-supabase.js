...
import { GetDashboardSummaryQueryParams, GetRevenueChartQueryParams, GetRecentTransactionsQueryParams, } from "../lib/api-zod";
const router = Router();
...
router.get("/dashboard/recent-transactions", async (req, res) => {
    ...
    try {
        const recentTransactions = await SupabaseDB.getRecentTransactions(query.data.limit);
